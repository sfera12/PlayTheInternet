...
//    alert('no playTheInternetParse function, reload this tab');
    ...
    chrome.runtime.sendMessage({operation:"parsedPlaylist", data:playTheInternetParse(document.documentElement.innerHTML), href:window.location.href.substring(0, 75)});
}
