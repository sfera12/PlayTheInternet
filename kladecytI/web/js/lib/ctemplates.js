...
with(obj||{}){
__p+='<div><div class="image-div"><img src="http://cdn.ndtv.com/tech/images/youtube_logo_120.jpg"><div class="pti-logo"></div><div class="pti-logo"></div></div><span class="videoText"><b>'+
((__t=( id ))==null?'':__t)+
'</b></span></div>';
}
return __p;
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div><div class="image-div"><img src="'+
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div><div class="image-div"><img src="http://s.ytimg.com/yts/img/meh7-vflGevej7.png"><div class="pti-logo"></div></div><span class="error-text"><b><a href="http://www.youtube.com/watch?v='+
((__t=(id))==null?'':__t)+
'" target="_blank">'+
((__t=(error))==null?'':__t)+
'</a></b></span></div>';
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div><div class="image-div"><img src="/css/resources/vimeo.jpg"><div class="pti-logo"></div></div><span class="videoText"><b>'+
((__t=( id ))==null?'':__t)+
'</b></span></div>';
}
return __p;
...
__p+='<div id="'+
((__t=(id))==null?'':__t)+
'" class="pti-element"><div> <div class="pti-sortable-handler image-div"><img src="'+
...
'</div> </div> <div class="pti-playlists-buttons"> <div class="pti-play-all pti-clickable">Play All</div> <div class="pti-add-all pti-clickable">Add All</div> <div class="pti-remove-playlist pti-clickable">Remove Playlist</div> </div> </div> </div> </div>';
}
return __p;
}
