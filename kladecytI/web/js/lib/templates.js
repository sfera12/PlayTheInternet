...
PTITemplates.prototype.YoutubeErrorTemplate = _.template('<div><div class="image-div pti-sortable-handler"><img src="http://s.ytimg.com/yts/img/meh7-vflGevej7.png"><div class="pti-logo"></div></div><span class="error-text"><b><a href="http://www.youtube.com/watch?v=<%=id%>" target="_blank"><%=error%></a></b></span></div>');
